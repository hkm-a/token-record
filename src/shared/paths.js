...
// 数据源路径解析：集中管理四个 CLI 工具在本机的会话数据根目录。
...
const SOURCE_ROOTS = {
  ...
  // Pi：sessions/<编码cwd>/<sessionId>.jsonl。
  pi: process.env.TOKENREC_PI_DIR || path.join(HOME, '.pi', 'agent', 'sessions'),
